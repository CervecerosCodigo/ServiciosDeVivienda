...
public class ControllerToppPanelMegler<E> implements VisMeldingInterface {
	...
	public void sendSokeResultat(ArrayList<E> sokeResultat) {
		...
		if (false) visMelding("Søk", "Søkefeltet er tomt.\nBruk * for å vise hele registeret.");
			...
			case Bolig:
				sokeResultat = fsearch.searchForPattern(boligliste, soketekst); break;
			case Utleier:
				sokeResultat = fsearch.searchForPatternIUtleier(personliste, soketekst); break;
			case Leietaker:
				sokeResultat = fsearch.searchForPatternILeietaker(personliste, soketekst); break;
			case Annonse:
				sokeResultat = fsearch.searchForPattern(annonseliste, soketekst); break;
			case Kontrakt:
				sokeResultat = fsearch.searchForPattern(kontraktliste, soketekst); break;
			case Soknad:
				sokeResultat = fsearch.searchForPattern(soknadsliste, soketekst); break;
			default:
